...
% Add this near the top of the file with other usepackage statements
\usepackage{newtxtext}
\usepackage{newtxmath} % For math symbols to match Times New Roman
\usepackage{mathptmx} % For text to match Times New Roman

% Remove or comment out all other font-related packages in the FONT OPTIONS section
%----------FONT OPTIONS----------
% sans-serif
...
% Modify this section to align text to the left instead of centering
\noindent\textbf{\huge \scshape Zhichuan MA} \\ \vspace{1pt}
